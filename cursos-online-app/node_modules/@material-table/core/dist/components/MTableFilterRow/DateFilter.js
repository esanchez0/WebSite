...
function DateFilter(_ref) {
  ...
  if (columnDef.type === 'date') {
    dateInputElement = /*#__PURE__*/_react["default"].createElement(_lab.DatePicker, (0, _extends2["default"])({}, pickerProps, {
      ref: forwardedRef
    }));
  } else if (columnDef.type === 'datetime') {
    dateInputElement = /*#__PURE__*/_react["default"].createElement(_lab.DateTimePicker, (0, _extends2["default"])({}, pickerProps, {
      ref: forwardedRef
    }));
  } else if (columnDef.type === 'time') {
    dateInputElement = /*#__PURE__*/_react["default"].createElement(_lab.TimePicker, (0, _extends2["default"])({}, pickerProps, {
      ref: forwardedRef
    }));
  }

  return /*#__PURE__*/_react["default"].createElement(_lab.LocalizationProvider, {

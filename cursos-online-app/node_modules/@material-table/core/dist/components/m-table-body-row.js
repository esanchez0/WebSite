  ...
  (0, _createClass2["default"])(MTableBodyRow, [{
    ...
    value: function renderColumns() {
      ...
      var mapArr = this.props.columns.filter(function (columnDef) {
        ...
        if (_this2.props.data.tableData.editCellList && _this2.props.data.tableData.editCellList.find(function (c) {
          ...
          return /*#__PURE__*/_react["default"].createElement(_this2.props.components.EditCell, {
          ...
          var isEditable = columnDef.editable !== 'never' && !!_this2.props.cellEditable;

          if (isEditable && _this2.props.cellEditable.isCellEditable) {
            isEditable = _this2.props.cellEditable.isCellEditable(_this2.props.data, columnDef);
          }

          var key = "cell-".concat(_this2.props.data.tableData.id, "-").concat(columnDef.tableData.id);
    ...
    value: function renderDetailPanelColumn() {
      ...
      if (typeof this.props.detailPanel === 'function') {
        ...
        }, /*#__PURE__*/_react["default"].createElement(this.props.icons.DetailPanel, null)));
      } else {
        return /*#__PURE__*/_react["default"].createElement(_TableCell["default"], {
          size: size,
          padding: "none",
          ...
          var iconButton = /*#__PURE__*/_react["default"].createElement(_this4.props.icons.DetailPanel, null);
    ...
    value: function getStyle(index, level) {
      ...
      if (typeof this.props.options.rowStyle === 'function') {
        style = _objectSpread(_objectSpread({}, style), this.props.options.rowStyle(this.props.data, index, level, this.props.hasAnyEditingRow));
      } else if (this.props.options.rowStyle) {
        style = _objectSpread(_objectSpread({}, style), this.props.options.rowStyle);
      }
    ...
    value: function render() {
      ...
      var rowActions = CommonValues.rowActions(this.props);
      ...
      if (rowActions.length > 0) {
        if (this.props.options.actionsColumnIndex === -1) {
          ...
          renderColumns.splice(this.props.options.actionsColumnIndex + endPos, 0, this.renderActions(rowActions));
        }
      ...
      }), renderColumns), this.props.data.tableData && this.props.data.tableData.showDetailPanel && /*#__PURE__*/_react["default"].createElement(_TableRow["default"] // selected={this.props.index % 2 === 0}
      , null, this.props.options.detailPanelOffset.left > 0 && /*#__PURE__*/_react["default"].createElement(_TableCell["default"], {
        colSpan: this.props.options.detailPanelOffset.left
      }), /*#__PURE__*/_react["default"].createElement(_TableCell["default"], {
        size: size,
        colSpan: renderColumns.length - this.props.options.detailPanelOffset.left - this.props.options.detailPanelOffset.right,
        padding: "none"
        ...
        if (data.tableData.editing) {
          return /*#__PURE__*/_react["default"].createElement(_this6.props.components.EditRow, {
          ...
          return /*#__PURE__*/_react["default"].createElement(_this6.props.components.Row, (0, _extends2["default"])({}, _this6.props, {
            data: data,
            index: index,
            key: index,
